...
$singleDeveloperParams = @{
    ...
    SqlServer = [System.Text.Encoding]::UTF8.GetString([System.Convert]::FromBase64String($SqlServer))
    SqlAdminUser = [System.Text.Encoding]::UTF8.GetString([System.Convert]::FromBase64String($SqlAdminUser))
    SqlAdminPassword = [System.Text.Encoding]::UTF8.GetString([System.Convert]::FromBase64String($SqlAdminPassword))
    SitecoreAdminPassword = [System.Text.Encoding]::UTF8.GetString([System.Convert]::FromBase64String($SitecoreAdminPassword))
    SolrUrl = [System.Text.Encoding]::UTF8.GetString([System.Convert]::FromBase64String($SolrUrl))
    SolrRoot = [System.Text.Encoding]::UTF8.GetString([System.Convert]::FromBase64String($SolrRoot))
    SolrService = [System.Text.Encoding]::UTF8.GetString([System.Convert]::FromBase64String($SolrService))
    Prefix = [System.Text.Encoding]::UTF8.GetString([System.Convert]::FromBase64String($Prefix))
    XConnectCertificateName = [System.Text.Encoding]::UTF8.GetString([System.Convert]::FromBase64String($XConnectSiteName))
    IdentityServerCertificateName = [System.Text.Encoding]::UTF8.GetString([System.Convert]::FromBase64String($IdentityServerSiteName))
    IdentityServerSiteName = [System.Text.Encoding]::UTF8.GetString([System.Convert]::FromBase64String($IdentityServerSiteName))
    LicenseFile = [System.Text.Encoding]::UTF8.GetString([System.Convert]::FromBase64String($LicenseFile))
    XConnectPackage = [System.Text.Encoding]::UTF8.GetString([System.Convert]::FromBase64String($XConnectPackage))
    SitecorePackage = [System.Text.Encoding]::UTF8.GetString([System.Convert]::FromBase64String($SitecorePackage))
    IdentityServerPackage = [System.Text.Encoding]::UTF8.GetString([System.Convert]::FromBase64String($IdentityServerPackage))
    XConnectSiteName = [System.Text.Encoding]::UTF8.GetString([System.Convert]::FromBase64String($XConnectSiteName))
    SitecoreSitename = [System.Text.Encoding]::UTF8.GetString([System.Convert]::FromBase64String($SitecoreSiteName))
    PasswordRecoveryUrl = [System.Text.Encoding]::UTF8.GetString([System.Convert]::FromBase64String($PasswordRecoveryUrl))
    SitecoreIdentityAuthority = [System.Text.Encoding]::UTF8.GetString([System.Convert]::FromBase64String($SitecoreIdentityAuthority))
    XConnectCollectionService = [System.Text.Encoding]::UTF8.GetString([System.Convert]::FromBase64String($XConnectCollectionService))
    ClientSecret = [System.Text.Encoding]::UTF8.GetString([System.Convert]::FromBase64String($ClientSecret))
    AllowedCorsOrigins = [System.Text.Encoding]::UTF8.GetString([System.Convert]::FromBase64String($AllowedCorsOrigins))
}
