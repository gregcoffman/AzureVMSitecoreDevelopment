#https://github.com/chorpo/Sitecore9Installation/blob/master/Sitecore9.2/01_InstallSolr75_ByPeterProchazka_OpenJdk.ps1

Param(  
    $installFolder = "C:\solr721",
    $solrPort = "8750",
    $solrHost = "localhost",
    $solrSSL = $true,
...
#if($env:JAVA_HOME -eq $null) { #Removed because we need this to set regardless of if it's null
